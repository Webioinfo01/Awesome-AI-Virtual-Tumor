# Awesome Perturbation-to-Phenotype AI[![Awesome](https://awesome.re/badge.svg)](https://awesome.re)
[![Website](https://img.shields.io/website?url=http%3A//awesome-perturbation-phenotype.webioinfo.top/)](http://awesome-perturbation-phenotype.webioinfo.top/)
[![GitHub Stars](https://img.shields.io/github/stars/Webioinfo01/Awesome-Perturbation-to-Phenotype-AI?style=social)](https://github.com/Webioinfo01/Awesome-Perturbation-to-Phenotype-AI) 
[![visitors](https://visitor-badge.laobi.icu/badge?page_id=Webioinfo01.Awesome-Perturbation-to-Phenotype-AI)](https://github.com/Webioinfo01/Awesome-Perturbation-to-Phenotype-AI)

**Visit the official website at: http://awesome-perturbation-phenotype.webioinfo.top/**
...
- [💾 Databases](#Databases) - Databases and data repositories related to sequences and single-cell data for perturbation-to-phenotype research.
- [🔧 Tools & Infrastructure](#Tools--Infrastructure) - Tools and infrastructure for perturbation-to-phenotype research, including annotation frameworks, simulation tools, and standardization utilities.
...
- [🌐 Other Domain Foundation Models](#Other-Domain-Foundation-Models) - Foundation models from other domains (e.g., cognitive science) that can be applied to perturbation-to-phenotype mapping.
...
- [Awesome AI Meets Biology](https://github.com/Webioinfo01/Awesome-AI-Meets-Biology) - A comprehensive survey of AI applications in biology, bioinformatics, and biomedical research
...
```bibtex
@misc{awesome-perturbation-phenotype-ai,
  title={Awesome Perturbation-to-Phenotype AI},
  author={Webioinfo01},
  year={2025},
  url={https://github.com/Webioinfo01/Awesome-Perturbation-to-Phenotype-AI}
}
```
